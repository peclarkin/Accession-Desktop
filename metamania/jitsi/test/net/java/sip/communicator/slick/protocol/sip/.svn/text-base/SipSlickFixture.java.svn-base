    ...
    extends TestCase
{
    ...
    /**
     * Indicates whether or not the user has requested for the tests that rely
     * on SIP messaging to be disabled or not
     */
    public static boolean disableSipMessagingTests = false;
