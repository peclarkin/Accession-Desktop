    ...
    implements BundleActivator
{
    ...
    /**
     * The name of the property that indicates whether the user would like to
     * disable the multi-user chat tests
     */
    public static final String DISABLE_MULTI_USER_TESTS_PROPERTY_NAME
        = "accounts.jabber.DISABLE_MULTI_USER_TESTS";
    ...
    public void start(BundleContext context)
    {
        ...
        // Verify if the user wants to avoid multi-chat testing
        String disableMultiChat =
                     System.getProperty(DISABLE_MULTI_USER_TESTS_PROPERTY_NAME);

        if ("true".equalsIgnoreCase(disableMultiChat))
            JabberSlickFixture.multiChatTestingDisabled = true;
...
//            addTest(TestOperationSetMultiUserChat.suite());
            if (!JabberSlickFixture.multiChatTestingDisabled)
