    ...
    implements BundleActivator
{
    ...
    /**
     * The name of the property that indicates whether the user would like to
     * disable the tests that rely on SIP for messaging
     */
    public static final String DISABLE_SIP_MESSAGING_TESTS_PROPERTY_NAME
        = "accounts.sip.DISABLE_SIP_MESSAGING_TESTING";
    ...
    public void start(BundleContext context)
    {
        ...
        String disableSipMessagingTests = 
                  System.getProperty(DISABLE_SIP_MESSAGING_TESTS_PROPERTY_NAME);
        
        if ("true".equalsIgnoreCase(disableSipMessagingTests))
            SipSlickFixture.disableSipMessagingTests = true;
        ...
        {
            if (!SipSlickFixture.disableSipMessagingTests)
            {
                // persistent presence
