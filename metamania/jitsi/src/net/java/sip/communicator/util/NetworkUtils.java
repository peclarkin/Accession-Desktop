...
public class NetworkUtils
{
    ...
    public static void reloadDnsResolverConfig()
    {
        ...
        // If trace is enabled, log the active DNS servers.
        traceActiveDNSServers();
    }
    ...
    /**
     * Logs the active DNS servers for the default resolver, if trace is
     * enabled.
     */
    private static void traceActiveDNSServers()
    {
        if(logger.isTraceEnabled())
        {
            ...
            if (resolverConfig == null)
            {
                ...
                sb.append("DNS resolver config is null.");
            }
            else if (resolverConfig.servers() == null)
            {
                // Null values in this area of the code are associated with
                // sporadic network connectivity.
                sb.append("List of active DNS servers in default resolver was null.");
            }
            else
            {
