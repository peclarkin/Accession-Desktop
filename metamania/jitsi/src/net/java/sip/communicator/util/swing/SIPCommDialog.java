    ...
    extends JDialog
{
    ...
    private void init()
    {
        ...
        this.setIconImage(UtilActivator.getImage("service.gui.SIP_COMMUNICATOR_LOGO"));
     ...
     * @param makeVisible indicates if the dialog should be made visible
     */
    public void setVisible(boolean makeVisible)
    {
        if (makeVisible)
        {
            ...
            if (isSaveSizeAndLocation && !isVisible)
            {
