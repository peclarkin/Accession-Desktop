    ...
    implements ActionListener
{
    ...
    /**
     * The check box indicating if the user credentials should be remembered.
     */
    private final JCheckBox rememberCredentialsCheckBox
        = new SIPCommCheckBox(UtilActivator.getResources()
                                 .getI18NString("service.gui.REMEMBER_DETAILS"),
    ...
    {
        rememberCredentialsCheckBox.setVisible(allow);
    }
    ...
    private void init()
    {
        ...
        this.rememberCredentialsCheckBox.setOpaque(false);
        this.rememberCredentialsCheckBox.setBorder(null);

        southFieldsPanel.add(rememberCredentialsCheckBox);
    ...
    public void actionPerformed(ActionEvent evt)
    {
        ...
        if ("ok".equals(buttonName))
        {
            ...
            isRememberPassword = rememberCredentialsCheckBox.isSelected();
        }
        else
        {
            isCanceled = true;
