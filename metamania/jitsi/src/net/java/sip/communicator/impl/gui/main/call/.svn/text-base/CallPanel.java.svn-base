               ...
               Skinnable
{
    ...
    private void updateMergeButtonState()
    {
        ...
        // Save the calls in progress in an unmodifiableCollection to avoid
        // ConcurrentModificationException
        Collection<Call> unmodifiableInProgressCalls =
            Collections.unmodifiableCollection(CallManager.getInProgressCalls());

        for (Call call : unmodifiableInProgressCalls)
        {
