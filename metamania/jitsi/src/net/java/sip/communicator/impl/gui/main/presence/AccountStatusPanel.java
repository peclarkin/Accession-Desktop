                ...
                Skinnable
{
    ...
    /**
     * The call status plug-in container.
     */
    private final TransparentPanel callStatusPluginPanel;
    ...
    /**
     * Plugin container for the call manager plugin.  Keep reference or it will
     * lose its listener.
     */
    @SuppressWarnings("unused")
    private final PluginContainer callStatusPluginContainer;
    ...
    public AccountStatusPanel(MainFrame mainFrame)
    {
        ...
        // Add the call status plugin container
        callStatusPluginPanel = new TransparentPanel(new BorderLayout(0, 0));
        callStatusPluginContainer = new PluginContainer(callStatusPluginPanel,
                                      Container.CONTAINER_ACCOUNT_STATUS_SOUTH);
        statusToolsPanel.add(callStatusPluginPanel, BorderLayout.SOUTH);
