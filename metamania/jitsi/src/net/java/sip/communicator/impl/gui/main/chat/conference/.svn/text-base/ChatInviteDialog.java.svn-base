    ...
    extends InviteDialog
{
    ...
    private void inviteContacts()
    {
        ...
        Collection<UIContact> selectedContacts = destContactList
                                                    .getContacts(null);
        ...
        Iterator<UIContact> selectedContactsIt = selectedContacts.iterator();

        while (selectedContactsIt.hasNext())
        {
            UIContact uiContact = selectedContactsIt.next();
