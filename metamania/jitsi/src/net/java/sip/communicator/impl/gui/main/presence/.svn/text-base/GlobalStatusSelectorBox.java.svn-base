    ...
    implements ActionListener
{
    ...
    /**
     * The number of accounts that we show in the menu
     */
    ...
    public GlobalStatusSelectorBox(MainFrame mainFrame)
    {
        ...
        // By default this is hidden, until we know we have some accounts
        setVisible(false);
    }
    ...
    public void addAccount(ProtocolProviderService protocolProvider)
    {
        ...
        // Make visible as we know we are adding an account
        numberAccounts++;
        setVisible(true);
