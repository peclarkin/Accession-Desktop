                ...
                LocalUserAdHocChatRoomPresenceListener
{
    ...
    /**
     * Property to check to see if message history is enabled.
     */
    String MESSAGE_HISTORY_ENABLED_PROPERTY =
    ...
    {
        // If we're not logging message history, don't continue.
    ...
    private boolean isMessageHistoryEnabled()
    {
        String isMessageHistoryEnabledString = configService.getString(
            MESSAGE_HISTORY_ENABLED_PROPERTY);

        if(isMessageHistoryEnabledString == null)
            isMessageHistoryEnabledString =
                getResources().
                getSettingsString(MESSAGE_HISTORY_ENABLED_PROPERTY);

        // If the property doesn't exist we assume it's disabled.
        if (isMessageHistoryEnabledString == null
        ...
        {
            return new Boolean(isMessageHistoryEnabledString).booleanValue();
        }
    }
}
