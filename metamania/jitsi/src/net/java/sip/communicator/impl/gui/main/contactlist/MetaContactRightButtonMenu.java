                ...
                Skinnable
{
    ...
    private void init()
    {
        ...
        while (contacts.hasNext())
        {
            ...
            // If the persistent presence operation set is marked as not
            // having user-visible addresses, use the display name instead.
            ...
            if (opSets.containsKey(ppOpSetKey))
            {
                ...
                {
                    contactAddress = contact.getDisplayName();
                }
            }
